...
from aiokubernetes.models.v1_pod_anti_affinity import V1PodAntiAffinity  # noqa: E501
...
class TestV1PodAntiAffinity(unittest.TestCase):
    ...
    def testV1PodAntiAffinity(self):
        ...
        # model = aiokubernetes.models.v1_pod_anti_affinity.V1PodAntiAffinity()  # noqa: E501
        pass
