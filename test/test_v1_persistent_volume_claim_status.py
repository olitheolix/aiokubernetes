...
from aiokubernetes.models.v1_persistent_volume_claim_status import V1PersistentVolumeClaimStatus  # noqa: E501
...
class TestV1PersistentVolumeClaimStatus(unittest.TestCase):
    ...
    def testV1PersistentVolumeClaimStatus(self):
        ...
        # model = aiokubernetes.models.v1_persistent_volume_claim_status.V1PersistentVolumeClaimStatus()  # noqa: E501
        pass
