...
from aiokubernetes.models.v1_daemon_endpoint import V1DaemonEndpoint  # noqa: E501
...
class TestV1DaemonEndpoint(unittest.TestCase):
    ...
    def testV1DaemonEndpoint(self):
        ...
        # model = aiokubernetes.models.v1_daemon_endpoint.V1DaemonEndpoint()  # noqa: E501
        pass
