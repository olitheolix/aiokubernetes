...
from aiokubernetes.models.v1_component_status import V1ComponentStatus  # noqa: E501
...
class TestV1ComponentStatus(unittest.TestCase):
    ...
    def testV1ComponentStatus(self):
        ...
        # model = aiokubernetes.models.v1_component_status.V1ComponentStatus()  # noqa: E501
        pass
