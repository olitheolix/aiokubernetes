...
from aiokubernetes.models.v1_resource_quota_spec import V1ResourceQuotaSpec  # noqa: E501
...
class TestV1ResourceQuotaSpec(unittest.TestCase):
    ...
    def testV1ResourceQuotaSpec(self):
        ...
        # model = aiokubernetes.models.v1_resource_quota_spec.V1ResourceQuotaSpec()  # noqa: E501
        pass
