...
from aiokubernetes.api.autoscaling_v1_api import AutoscalingV1Api  # noqa: E501
...
class TestAutoscalingV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = aiokubernetes.api.autoscaling_v1_api.AutoscalingV1Api(None)  # noqa: E501
