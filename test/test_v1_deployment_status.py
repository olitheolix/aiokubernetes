...
from aiokubernetes.models.v1_deployment_status import V1DeploymentStatus  # noqa: E501
...
class TestV1DeploymentStatus(unittest.TestCase):
    ...
    def testV1DeploymentStatus(self):
        ...
        # model = aiokubernetes.models.v1_deployment_status.V1DeploymentStatus()  # noqa: E501
        pass
