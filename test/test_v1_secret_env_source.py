...
from aiokubernetes.models.v1_secret_env_source import V1SecretEnvSource  # noqa: E501
...
class TestV1SecretEnvSource(unittest.TestCase):
    ...
    def testV1SecretEnvSource(self):
        ...
        # model = aiokubernetes.models.v1_secret_env_source.V1SecretEnvSource()  # noqa: E501
        pass
