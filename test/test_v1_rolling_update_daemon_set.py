...
from aiokubernetes.models.v1_rolling_update_daemon_set import V1RollingUpdateDaemonSet  # noqa: E501
...
class TestV1RollingUpdateDaemonSet(unittest.TestCase):
    ...
    def testV1RollingUpdateDaemonSet(self):
        ...
        # model = aiokubernetes.models.v1_rolling_update_daemon_set.V1RollingUpdateDaemonSet()  # noqa: E501
        pass
