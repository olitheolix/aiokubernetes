...
from aiokubernetes.models.v1_token_review_status import V1TokenReviewStatus  # noqa: E501
...
class TestV1TokenReviewStatus(unittest.TestCase):
    ...
    def testV1TokenReviewStatus(self):
        ...
        # model = aiokubernetes.models.v1_token_review_status.V1TokenReviewStatus()  # noqa: E501
        pass
