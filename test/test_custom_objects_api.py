...
from aiokubernetes.api.custom_objects_api import CustomObjectsApi  # noqa: E501
...
class TestCustomObjectsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = aiokubernetes.api.custom_objects_api.CustomObjectsApi(None)  # noqa: E501
