...
from aiokubernetes.api.rbac_authorization_v1alpha1_api import RbacAuthorizationV1alpha1Api  # noqa: E501
...
class TestRbacAuthorizationV1alpha1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = aiokubernetes.api.rbac_authorization_v1alpha1_api.RbacAuthorizationV1alpha1Api(None)  # noqa: E501
