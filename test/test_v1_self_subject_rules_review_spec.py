...
from aiokubernetes.models.v1_self_subject_rules_review_spec import V1SelfSubjectRulesReviewSpec  # noqa: E501
...
class TestV1SelfSubjectRulesReviewSpec(unittest.TestCase):
    ...
    def testV1SelfSubjectRulesReviewSpec(self):
        ...
        # model = aiokubernetes.models.v1_self_subject_rules_review_spec.V1SelfSubjectRulesReviewSpec()  # noqa: E501
        pass
