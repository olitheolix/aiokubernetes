...
from aiokubernetes.api.rbac_authorization_v1_api import RbacAuthorizationV1Api  # noqa: E501
...
class TestRbacAuthorizationV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = aiokubernetes.api.rbac_authorization_v1_api.RbacAuthorizationV1Api(None)  # noqa: E501
