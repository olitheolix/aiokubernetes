...
from aiokubernetes.models.v1_network_policy_peer import V1NetworkPolicyPeer  # noqa: E501
...
class TestV1NetworkPolicyPeer(unittest.TestCase):
    ...
    def testV1NetworkPolicyPeer(self):
        ...
        # model = aiokubernetes.models.v1_network_policy_peer.V1NetworkPolicyPeer()  # noqa: E501
        pass
