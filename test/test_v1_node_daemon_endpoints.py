...
from aiokubernetes.models.v1_node_daemon_endpoints import V1NodeDaemonEndpoints  # noqa: E501
...
class TestV1NodeDaemonEndpoints(unittest.TestCase):
    ...
    def testV1NodeDaemonEndpoints(self):
        ...
        # model = aiokubernetes.models.v1_node_daemon_endpoints.V1NodeDaemonEndpoints()  # noqa: E501
        pass
