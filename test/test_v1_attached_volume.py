...
from aiokubernetes.models.v1_attached_volume import V1AttachedVolume  # noqa: E501
...
class TestV1AttachedVolume(unittest.TestCase):
    ...
    def testV1AttachedVolume(self):
        ...
        # model = aiokubernetes.models.v1_attached_volume.V1AttachedVolume()  # noqa: E501
        pass
