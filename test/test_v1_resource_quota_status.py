...
from aiokubernetes.models.v1_resource_quota_status import V1ResourceQuotaStatus  # noqa: E501
...
class TestV1ResourceQuotaStatus(unittest.TestCase):
    ...
    def testV1ResourceQuotaStatus(self):
        ...
        # model = aiokubernetes.models.v1_resource_quota_status.V1ResourceQuotaStatus()  # noqa: E501
        pass
