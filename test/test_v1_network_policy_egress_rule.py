...
from aiokubernetes.models.v1_network_policy_egress_rule import V1NetworkPolicyEgressRule  # noqa: E501
...
class TestV1NetworkPolicyEgressRule(unittest.TestCase):
    ...
    def testV1NetworkPolicyEgressRule(self):
        ...
        # model = aiokubernetes.models.v1_network_policy_egress_rule.V1NetworkPolicyEgressRule()  # noqa: E501
        pass
