...
from aiokubernetes.models.v1_glusterfs_volume_source import V1GlusterfsVolumeSource  # noqa: E501
...
class TestV1GlusterfsVolumeSource(unittest.TestCase):
    ...
    def testV1GlusterfsVolumeSource(self):
        ...
        # model = aiokubernetes.models.v1_glusterfs_volume_source.V1GlusterfsVolumeSource()  # noqa: E501
        pass
