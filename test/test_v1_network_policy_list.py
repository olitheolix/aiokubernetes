...
from aiokubernetes.models.v1_network_policy_list import V1NetworkPolicyList  # noqa: E501
...
class TestV1NetworkPolicyList(unittest.TestCase):
    ...
    def testV1NetworkPolicyList(self):
        ...
        # model = aiokubernetes.models.v1_network_policy_list.V1NetworkPolicyList()  # noqa: E501
        pass
