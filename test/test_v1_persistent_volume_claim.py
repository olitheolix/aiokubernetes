...
from aiokubernetes.models.v1_persistent_volume_claim import V1PersistentVolumeClaim  # noqa: E501
...
class TestV1PersistentVolumeClaim(unittest.TestCase):
    ...
    def testV1PersistentVolumeClaim(self):
        ...
        # model = aiokubernetes.models.v1_persistent_volume_claim.V1PersistentVolumeClaim()  # noqa: E501
        pass
