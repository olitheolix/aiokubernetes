...
from aiokubernetes.models.v1_server_address_by_client_cidr import V1ServerAddressByClientCIDR  # noqa: E501
...
class TestV1ServerAddressByClientCIDR(unittest.TestCase):
    ...
    def testV1ServerAddressByClientCIDR(self):
        ...
        # model = aiokubernetes.models.v1_server_address_by_client_cidr.V1ServerAddressByClientCIDR()  # noqa: E501
        pass
