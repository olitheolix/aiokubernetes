...
from aiokubernetes.models.v1_endpoint_subset import V1EndpointSubset  # noqa: E501
...
class TestV1EndpointSubset(unittest.TestCase):
    ...
    def testV1EndpointSubset(self):
        ...
        # model = aiokubernetes.models.v1_endpoint_subset.V1EndpointSubset()  # noqa: E501
        pass
