...
from aiokubernetes.api.scheduling_v1alpha1_api import SchedulingV1alpha1Api  # noqa: E501
...
class TestSchedulingV1alpha1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = aiokubernetes.api.scheduling_v1alpha1_api.SchedulingV1alpha1Api(None)  # noqa: E501
