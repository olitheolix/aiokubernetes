...
from aiokubernetes.models.v1_secret_volume_source import V1SecretVolumeSource  # noqa: E501
...
class TestV1SecretVolumeSource(unittest.TestCase):
    ...
    def testV1SecretVolumeSource(self):
        ...
        # model = aiokubernetes.models.v1_secret_volume_source.V1SecretVolumeSource()  # noqa: E501
        pass
