...
from aiokubernetes.models.v1_daemon_set_update_strategy import V1DaemonSetUpdateStrategy  # noqa: E501
...
class TestV1DaemonSetUpdateStrategy(unittest.TestCase):
    ...
    def testV1DaemonSetUpdateStrategy(self):
        ...
        # model = aiokubernetes.models.v1_daemon_set_update_strategy.V1DaemonSetUpdateStrategy()  # noqa: E501
        pass
