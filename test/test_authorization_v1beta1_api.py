...
from aiokubernetes.api.authorization_v1beta1_api import AuthorizationV1beta1Api  # noqa: E501
...
class TestAuthorizationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = aiokubernetes.api.authorization_v1beta1_api.AuthorizationV1beta1Api(None)  # noqa: E501
