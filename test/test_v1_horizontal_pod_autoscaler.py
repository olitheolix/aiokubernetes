...
from aiokubernetes.models.v1_horizontal_pod_autoscaler import V1HorizontalPodAutoscaler  # noqa: E501
...
class TestV1HorizontalPodAutoscaler(unittest.TestCase):
    ...
    def testV1HorizontalPodAutoscaler(self):
        ...
        # model = aiokubernetes.models.v1_horizontal_pod_autoscaler.V1HorizontalPodAutoscaler()  # noqa: E501
        pass
