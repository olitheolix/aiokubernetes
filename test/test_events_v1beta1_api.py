...
from aiokubernetes.api.events_v1beta1_api import EventsV1beta1Api  # noqa: E501
...
class TestEventsV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = aiokubernetes.api.events_v1beta1_api.EventsV1beta1Api(None)  # noqa: E501
