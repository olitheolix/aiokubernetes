...
from aiokubernetes.models.v1_preferred_scheduling_term import V1PreferredSchedulingTerm  # noqa: E501
...
class TestV1PreferredSchedulingTerm(unittest.TestCase):
    ...
    def testV1PreferredSchedulingTerm(self):
        ...
        # model = aiokubernetes.models.v1_preferred_scheduling_term.V1PreferredSchedulingTerm()  # noqa: E501
        pass
