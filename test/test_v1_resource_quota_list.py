...
from aiokubernetes.models.v1_resource_quota_list import V1ResourceQuotaList  # noqa: E501
...
class TestV1ResourceQuotaList(unittest.TestCase):
    ...
    def testV1ResourceQuotaList(self):
        ...
        # model = aiokubernetes.models.v1_resource_quota_list.V1ResourceQuotaList()  # noqa: E501
        pass
