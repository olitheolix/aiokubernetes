...
from aiokubernetes.models.v1_load_balancer_ingress import V1LoadBalancerIngress  # noqa: E501
...
class TestV1LoadBalancerIngress(unittest.TestCase):
    ...
    def testV1LoadBalancerIngress(self):
        ...
        # model = aiokubernetes.models.v1_load_balancer_ingress.V1LoadBalancerIngress()  # noqa: E501
        pass
