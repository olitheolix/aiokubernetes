...
from aiokubernetes.models.v1_self_subject_rules_review import V1SelfSubjectRulesReview  # noqa: E501
...
class TestV1SelfSubjectRulesReview(unittest.TestCase):
    ...
    def testV1SelfSubjectRulesReview(self):
        ...
        # model = aiokubernetes.models.v1_self_subject_rules_review.V1SelfSubjectRulesReview()  # noqa: E501
        pass
