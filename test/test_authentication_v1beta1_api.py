...
from aiokubernetes.api.authentication_v1beta1_api import AuthenticationV1beta1Api  # noqa: E501
...
class TestAuthenticationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = aiokubernetes.api.authentication_v1beta1_api.AuthenticationV1beta1Api(None)  # noqa: E501
