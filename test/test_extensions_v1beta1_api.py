...
from aiokubernetes.api.extensions_v1beta1_api import ExtensionsV1beta1Api  # noqa: E501
...
class TestExtensionsV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = aiokubernetes.api.extensions_v1beta1_api.ExtensionsV1beta1Api(None)  # noqa: E501
