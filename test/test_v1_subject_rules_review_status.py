...
from aiokubernetes.models.v1_subject_rules_review_status import V1SubjectRulesReviewStatus  # noqa: E501
...
class TestV1SubjectRulesReviewStatus(unittest.TestCase):
    ...
    def testV1SubjectRulesReviewStatus(self):
        ...
        # model = aiokubernetes.models.v1_subject_rules_review_status.V1SubjectRulesReviewStatus()  # noqa: E501
        pass
