...
from aiokubernetes.models.v1_gce_persistent_disk_volume_source import V1GCEPersistentDiskVolumeSource  # noqa: E501
...
class TestV1GCEPersistentDiskVolumeSource(unittest.TestCase):
    ...
    def testV1GCEPersistentDiskVolumeSource(self):
        ...
        # model = aiokubernetes.models.v1_gce_persistent_disk_volume_source.V1GCEPersistentDiskVolumeSource()  # noqa: E501
        pass
