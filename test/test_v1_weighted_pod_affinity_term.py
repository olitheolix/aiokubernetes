...
from aiokubernetes.models.v1_weighted_pod_affinity_term import V1WeightedPodAffinityTerm  # noqa: E501
...
class TestV1WeightedPodAffinityTerm(unittest.TestCase):
    ...
    def testV1WeightedPodAffinityTerm(self):
        ...
        # model = aiokubernetes.models.v1_weighted_pod_affinity_term.V1WeightedPodAffinityTerm()  # noqa: E501
        pass
