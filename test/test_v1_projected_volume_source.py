...
from aiokubernetes.models.v1_projected_volume_source import V1ProjectedVolumeSource  # noqa: E501
...
class TestV1ProjectedVolumeSource(unittest.TestCase):
    ...
    def testV1ProjectedVolumeSource(self):
        ...
        # model = aiokubernetes.models.v1_projected_volume_source.V1ProjectedVolumeSource()  # noqa: E501
        pass
