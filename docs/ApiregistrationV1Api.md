# aiokubernetes.ApiregistrationV1Api
...
api_instance = aiokubernetes.ApiregistrationV1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1APIService() # V1APIService | 
