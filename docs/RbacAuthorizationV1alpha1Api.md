# aiokubernetes.RbacAuthorizationV1alpha1Api
...
api_instance = aiokubernetes.RbacAuthorizationV1alpha1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1alpha1ClusterRole() # V1alpha1ClusterRole | 
...
# create an instance of the API class
api_instance = aiokubernetes.RbacAuthorizationV1alpha1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1alpha1ClusterRoleBinding() # V1alpha1ClusterRoleBinding | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
body = aiokubernetes.V1alpha1Role() # V1alpha1Role | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
api_instance = aiokubernetes.RbacAuthorizationV1alpha1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1alpha1RoleBinding() # V1alpha1RoleBinding | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
