# aiokubernetes.PolicyV1beta1Api
...
api_instance = aiokubernetes.PolicyV1beta1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1beta1PodDisruptionBudget() # V1beta1PodDisruptionBudget | 
...
# create an instance of the API class
api_instance = aiokubernetes.PolicyV1beta1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.PolicyV1beta1PodSecurityPolicy() # PolicyV1beta1PodSecurityPolicy | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
