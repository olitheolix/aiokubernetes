# aiokubernetes.EventsV1beta1Api
...
api_instance = aiokubernetes.EventsV1beta1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1beta1Event() # V1beta1Event | 
