# aiokubernetes.AutoscalingV1Api
...
api_instance = aiokubernetes.AutoscalingV1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1HorizontalPodAutoscaler() # V1HorizontalPodAutoscaler | 
