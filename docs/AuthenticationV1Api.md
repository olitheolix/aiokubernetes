# aiokubernetes.AuthenticationV1Api
...
api_instance = aiokubernetes.AuthenticationV1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1TokenReview() # V1TokenReview | 
