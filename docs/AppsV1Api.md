...
api_instance = aiokubernetes.AppsV1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1ControllerRevision() # V1ControllerRevision | 
...
api_instance = aiokubernetes.AppsV1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1DaemonSet() # V1DaemonSet | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
api_instance = aiokubernetes.AppsV1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1Deployment() # V1Deployment | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
api_instance = aiokubernetes.AppsV1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1ReplicaSet() # V1ReplicaSet | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
api_instance = aiokubernetes.AppsV1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1StatefulSet() # V1StatefulSet | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
