# aiokubernetes.BatchV2alpha1Api
...
api_instance = aiokubernetes.BatchV2alpha1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V2alpha1CronJob() # V2alpha1CronJob | 
