# aiokubernetes.StorageV1alpha1Api
...
api_instance = aiokubernetes.StorageV1alpha1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1alpha1VolumeAttachment() # V1alpha1VolumeAttachment | 
