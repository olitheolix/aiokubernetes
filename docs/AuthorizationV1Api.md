# aiokubernetes.AuthorizationV1Api
...
api_instance = aiokubernetes.AuthorizationV1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1LocalSubjectAccessReview() # V1LocalSubjectAccessReview | 
...
# create an instance of the API class
api_instance = aiokubernetes.AuthorizationV1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1SelfSubjectAccessReview() # V1SelfSubjectAccessReview | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = aiokubernetes.AuthorizationV1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1SelfSubjectRulesReview() # V1SelfSubjectRulesReview | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
# create an instance of the API class
api_instance = aiokubernetes.AuthorizationV1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1SubjectAccessReview() # V1SubjectAccessReview | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
