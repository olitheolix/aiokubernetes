# aiokubernetes.RbacAuthorizationV1Api
...
api_instance = aiokubernetes.RbacAuthorizationV1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1ClusterRole() # V1ClusterRole | 
...
# create an instance of the API class
api_instance = aiokubernetes.RbacAuthorizationV1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1ClusterRoleBinding() # V1ClusterRoleBinding | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
body = aiokubernetes.V1Role() # V1Role | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
api_instance = aiokubernetes.RbacAuthorizationV1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1RoleBinding() # V1RoleBinding | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
