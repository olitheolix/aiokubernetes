# aiokubernetes.SchedulingV1alpha1Api
...
api_instance = aiokubernetes.SchedulingV1alpha1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1alpha1PriorityClass() # V1alpha1PriorityClass | 
