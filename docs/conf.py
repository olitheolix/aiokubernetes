...
htmlhelp_basename = 'aiokubernetesdoc'
...
latex_documents = [
    (master_doc, 'aiokubernetes.tex', 'aiokubernetes Documentation',
     'The Kubernetes Authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'aiokubernetes', 'aiokubernetes Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'aiokubernetes', 'aiokubernetes Documentation',
     author, 'aiokubernetes', 'One line description of project.',
     'Miscellaneous'),
]
