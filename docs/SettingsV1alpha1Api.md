# aiokubernetes.SettingsV1alpha1Api
...
api_instance = aiokubernetes.SettingsV1alpha1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1alpha1PodPreset() # V1alpha1PodPreset | 
