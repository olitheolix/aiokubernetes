# aiokubernetes.RbacAuthorizationV1beta1Api
...
api_instance = aiokubernetes.RbacAuthorizationV1beta1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1beta1ClusterRole() # V1beta1ClusterRole | 
...
# create an instance of the API class
api_instance = aiokubernetes.RbacAuthorizationV1beta1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1beta1ClusterRoleBinding() # V1beta1ClusterRoleBinding | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
body = aiokubernetes.V1beta1Role() # V1beta1Role | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
api_instance = aiokubernetes.RbacAuthorizationV1beta1Api(aiokubernetes.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = aiokubernetes.V1beta1RoleBinding() # V1beta1RoleBinding | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
