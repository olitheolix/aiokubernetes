# aiokubernetes.AuthenticationV1beta1Api
...
api_instance = aiokubernetes.AuthenticationV1beta1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1beta1TokenReview() # V1beta1TokenReview | 
