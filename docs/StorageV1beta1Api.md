# aiokubernetes.StorageV1beta1Api
...
api_instance = aiokubernetes.StorageV1beta1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1beta1StorageClass() # V1beta1StorageClass | 
...
# create an instance of the API class
api_instance = aiokubernetes.StorageV1beta1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1beta1VolumeAttachment() # V1beta1VolumeAttachment | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
