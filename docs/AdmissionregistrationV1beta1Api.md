# aiokubernetes.AdmissionregistrationV1beta1Api
...
api_instance = aiokubernetes.AdmissionregistrationV1beta1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1beta1MutatingWebhookConfiguration() # V1beta1MutatingWebhookConfiguration | 
...
# create an instance of the API class
api_instance = aiokubernetes.AdmissionregistrationV1beta1Api(aiokubernetes.ApiClient(configuration))
body = aiokubernetes.V1beta1ValidatingWebhookConfiguration() # V1beta1ValidatingWebhookConfiguration | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
